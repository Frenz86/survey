...
Ogni interessato ha il diritto di proporre reclamo al Garante per la Protezione dei Dati Personali qualora ritenga che il trattamento dei propri dati personali avvenga in violazione della normativa vigente. Il Garante può essere contattato attraverso il sito web www.gpdp.it, all'indirizzo email garante@gpdp.it, telefonicamente al numero 06.696771, oppure presso la sede di Piazza di Monte Citorio, 121 - 00186 Roma.

## 10. AGGIORNAMENTI DELL'INFORMATIVA

Questa informativa privacy può essere periodicamente modificata per adeguamenti normativi, organizzativi o tecnologici. Tutti gli aggiornamenti vengono pubblicati su questa pagina con chiara indicazione della data di ultima modifica. Si consiglia di consultare regolarmente questa sezione per rimanere informati su eventuali cambiamenti nelle modalità di trattamento dei dati.

## 11. UTILIZZO DEI COOKIE

Il presente sito web non utilizza cookie di profilazione, cookie di tracciamento pubblicitario o strumenti di analytics che consentano l'identificazione degli utenti. Vengono utilizzati esclusivamente cookie tecnici essenziali per il corretto funzionamento del sito, che non richiedono il consenso dell'utente in quanto strettamente necessari per l'erogazione del servizio richiesto.

Possono essere utilizzati anche cookie di preferenze per migliorare l'esperienza di navigazione dell'utente, sempre nel rispetto della privacy e senza alcuna finalità di profilazione o tracciamento comportamentale.
