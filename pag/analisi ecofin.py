...
def main():
   ...
   st.markdown("""
               ...
               L'obiettivo conoscitivo di questa sezione è di mettere in relazione l’andamento dei principali indici Eco-Fin con gli elementi raccolti nelle precedenti sezioni. 
